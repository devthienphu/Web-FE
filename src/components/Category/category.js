...
const Category = ({cate}) => {
    return (
        <>
            <div className={`bg-${cate.color}-100 rounded-xl items-center text-center px-12 py-10 shadow shadow-lg hover:scale-105 ease-in-out duration-300 hover:shadow-xl`}>
